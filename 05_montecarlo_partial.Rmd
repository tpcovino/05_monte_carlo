...
**Q6 (4 pts) Run the provided code (below) to generate a plot comparing the best model run for each objective function. Then, analyze the differences in model performance by answering the following:**
...
param <- arrange(param, desc(param$BLANK)) # kge
q2 <- unlist(param$qsim[1])
param <- arrange(param, BLANK) # rmse
