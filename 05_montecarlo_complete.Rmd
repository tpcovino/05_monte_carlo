...
Let's consider all of this in an example model called [WECOH - Watershed ECOHydrology](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1002/2014WR016719). In this study, researchers were interested in the change in subsurface water storage through time and space on a daily and seasonal basis.
...
Read data - this is the same PQ data from Tenderfoot Creek, MT which we have worked with in previous modules.
...
# set nse cutoff for behavioral model simulations. use 0.47 as threshold in this example. 
cutoff <- 0.7
...
Response surface plots - this chunk is just a demonstration of other ggplot visualizations that are available. If they take too long to run, don't worry about it. 
